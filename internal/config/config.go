...
// MustLoad загружает конфиг по пути который указан в переменной окружения "CONFIG_PATH"
// или в флаге командной строки "--config".
//
// "Must" в имени функции обозначает что функция не возвращает ошибку а сразу паникует.
